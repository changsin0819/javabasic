...
public class Ex02_Valuable 
{
	...
	public static void main(String[] args) 
	{
		...
		ok = true;						//		ok 변수에 참(true) 지정(저장)
		
		// -----------------------------------
		// [ 3 ] 출력
		
		System.out.println("문자변수 : "+ testCh);		   		// 문자형변수 testCh 출력
		System.out.println("정수형변수 : "+ jungsu);			//	정수형변수 jungsu 출력
		System.out.println("실수형변수 : "+ silsu);			//	실수형변수 silsu 출력
		System.out.println("논리형변수 : "+ ok);				//	논리형변수 ok 출력
	}
